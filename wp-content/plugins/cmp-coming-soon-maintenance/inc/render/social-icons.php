...
if ( get_option('niteoCS_socialmedia') ) {
    ...
    foreach ( $socialmedia as $social ) {
        ...
        if ( $social['hidden'] == '0' && $social['active'] == '1') {
            ...
            echo ( $mode == 'text' ) ? '<li class="social-child' . $liclass . '"><a href="'.$href.esc_attr($social['url']).'" target="top" class="social-'.$social['name'].'">'.$name.'</a></li>' : '<li class="social-child' . $liclass . '"><a href="'.$href.esc_attr($social['url']).'" target="top" class="social-'.$social['name'].'">'.$theme_html.'<i class="fa fa-'.$icon.'" aria-hidden="true"></i></a></li>';
        } 
    }
