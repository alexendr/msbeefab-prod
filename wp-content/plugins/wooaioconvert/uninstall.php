...
wp_clear_scheduled_hook('wcaiocc_cron_currency_exchange_rate_update_event'); // remove cron job
...
foreach ($options_list as $option_name){ // go through all plugin options
	...
	$option_name = 'wcaiocc_' . $option_name; // add prefix
