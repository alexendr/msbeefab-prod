 ...
 *
 * WooCommerce_All_in_One_Currency_Converter_Update_Notifier class is a class for handling plugin update/update notifications.
 * 
...
class WooCommerce_All_in_One_Currency_Converter_Update_Notifier {
