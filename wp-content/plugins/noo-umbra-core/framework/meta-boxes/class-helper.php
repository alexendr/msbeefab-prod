		...
		if ( !isset( $meta_box['fields'] ) || empty( $meta_box['fields'] ) ) {
			...
			case 'data-link':
				$meta_box['fields'][] = array(
					...
					'label' => esc_html__( 'The Link' , 'noo-umbra-core' ),
					'type' => 'text',
			...
			case 'data-video':
				$meta_box['fields'][] = array(
					...
					'label' => esc_html__( 'M4V File URL', 'noo-umbra-core' ),
					'desc' => esc_html__( 'Place the URL to your .m4v video file here.', 'noo-umbra-core' ),
					'type' => 'text',
				);
				$meta_box['fields'][] = array(
					'id' => $this->prefix . '_video_ogv',
					'label' => esc_html__( 'OGV File URL', 'noo-umbra-core' ),
					'desc' => esc_html__( 'Place the URL to your .ogv video file here.', 'noo-umbra-core' ),
					'type' => 'text',
				);
				$meta_box['fields'][] = array(
					'id' => $this->prefix . '_video_aspect_ratio',
					'label'    => esc_html__( 'Video Aspect Ratio', 'noo-umbra-core' ),
					'desc'    => esc_html__( 'Choose the aspect ratio for your video.', 'noo-umbra-core' ),
					'type'    => 'select',
					'std'     => '16:9',
					'options' => array(
				...
				$meta_box['fields'][] = array(
					...
					'label' => esc_html__( 'Embedded Video Code', 'noo-umbra-core' ),
					'desc' => esc_html__( 'If you are using something other than self hosted video (YouTube, Vimeo, etc.) paste the embed code here. This field will override the above settings.', 'noo-umbra-core' ),
					'type' => 'textarea',
					'std'  => ''
				);
				break;
			...
			case 'data-image':
				$meta_box['fields'][] = array(
					...
					'label' => esc_html__( 'Upload Image', 'noo-umbra-core' ),
					'type' => 'image',
				);
				break;
