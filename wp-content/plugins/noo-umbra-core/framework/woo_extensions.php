...
class Noo_Woocommerce_Extensions {
    ...
    public function show_product_all_images() {
        ...
        <div class="<?php echo implode(' ', $classes); ?>" data-showing="<?php echo $init_product_id; ?>" data-parentid="<?php echo $product->get_id(); ?>" data-default="<?php echo esc_attr( json_encode( $default_images ) ); ?>" data-slide-count="<?php echo count($image_ids); ?>">
            ...
            $count_thumb = 5;
            $mode_thumb  = "vertical";// "horizontal";
    ...
    public function frontend_script() {
        ...
        if ( ( function_exists('is_product') && is_product() ) ) {
            ...
            // Bxslider
            wp_register_script( 'bxslider', NOO_PLUGIN_ASSETS_URI . '/vendor/bxslider/jquery.bxslider.js', null, null, false );

            // Photoswipe
            wp_enqueue_script( 'photoswipe', NOO_PLUGIN_ASSETS_URI . '/vendor/photoswipe/photoswipe.js', array('jquery'), false, true );
            ...
            // Main
            wp_enqueue_style( $this->slug . '-css', NOO_PLUGIN_ASSETS_URI . '/css/noo.woo.extensions.css', array(), null, false );
            wp_enqueue_script( $this->slug . '-script', NOO_PLUGIN_ASSETS_URI . '/js/noo-woo-main.extensions.js', array('jquery', 'imagesloaded', 'bxslider'), null, true );
