...
class NOO_Customizer_Helper {
	...
	public function add_control(
		...
		$control_options2 = !empty( $control ) ? array_merge( $control_options2, $control ) : $control_options2;
		...
		case 'noo_logo':
			$wp_customize->add_control(
				new WP_Customize_Cropped_Image_Control( $wp_customize, $id, $control_options2 ) );
			break;
