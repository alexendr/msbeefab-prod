...
if ( ! class_exists( 'Noo_Check_Version_Child' ) ) {
    /**
     * This class is used for checking version of plugin/theme that rely on other product to get license.
     */
    class Noo_Check_Version_Child {
        ...
        /**
         * The prefix used for getting the license setting. It's also the ID of parent product.
         * Configured through the class's constructor.
         *
         * @var int     The product id of the related product in the license manager.
         */
         ...
         */
        public function __construct( $product_id, $product_name, $setting_prefix = '',
            $api_url, $type = 'plugin', $plugin_file = '' ) {
            // Store setup data
            $this->product_id = $product_id;
            $this->product_name = $product_name;
            $this->setting_prefix = !empty( $setting_prefix ) ? $setting_prefix : $product_id;
        ...
        protected function get_settings_field_name() {
            return $this->setting_prefix . '-license-settings';
        }
        ...
        protected function get_settings_page_slug() {
            return $this->setting_prefix . '-licenses';
        }
