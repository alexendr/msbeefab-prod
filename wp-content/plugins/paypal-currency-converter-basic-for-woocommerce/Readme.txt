...
Tags: woocommerce, paypal, currency conversion, exchange rate, ecommerce, e-commerce, store, sales, sell, shop, cart, checkout, downloadable, downloads, paypal, storefront, woo commerce
...
== Description ==
Convert any given WooCommerce shop currency to allowed PayPal currencies for PayPal's Payment Gateway within WooCommerce on checkout.
Actual Currency Exchange Rates will be retrieved from the provider of your choice.
Tool-tip help on every item.
Be aware that this is a basic version only and as such is not recommended for a real WooCommerce-shop since it is a limited version based on PAYPAL CURRENCY CONVERTER BASIC FOR WOOCOMMERCE that you can find on <a href="https://codecanyon.net/item/paypal-currency-converter-pro-for-woocommerce/6343249">CodeCanyon</a>.

Watch a demo of the PRO version on <a href="https://www.youtube.com/watch?v=B-rlzUBJ8B8">YouTube</a>
...
= How can I have 5 or more digits accuracy? =
...
1. Main settings section with custom currency setter, hisotic chart, etc.
2. Currency exchange rate provider selection section
3. Handling fee section
4. Order status handling and email order complete Note sections
5. Scheduled currency exchange rate update section
6. PayPal gateway selection
7. Paypal payment descriptionpay
8. Order notes in backend
9. Order details with handling fee on checkout
10. Email order note sample
11. Cron-Job list
12. Open Exchange Api
