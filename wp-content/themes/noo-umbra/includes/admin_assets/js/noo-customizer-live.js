...
( function( $ ) {
	...
	wp.customize( 'noo_typo_headings_font', function( value ) {
		value.bind( function( newval ) {
			...
			// Update style
			additionalStyle = 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1, .h2, .h3, .h4, .h5, .h6, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {font-family: "' + newval + '", sans-serif !important;}';
	...
	wp.customize( 'noo_typo_headings_font_style', function( value ) {
		value.bind( function( newval ) {
			...
			// Update style
			additionalStyle = 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1, .h2, .h3, .h4, .h5, .h6, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {font-style: ' + newval + ' !important;}';
			noo_update_live_css( additionalStyle );
		} );
	} );
	...
	wp.customize( 'noo_typo_headings_font_weight', function( value ) {
		value.bind( function( newval ) {
			...
			// Update style
			additionalStyle = 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1, .h2, .h3, .h4, .h5, .h6, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {font-weight: ' + newval + ' !important;}';
			noo_update_live_css( additionalStyle );
		} );
	} );
	...
	wp.customize( 'noo_typo_headings_font_color', function( value ) {
		value.bind( function( newval ) {
			additionalStyle = 'h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6 {color: ' + newval + ' !important;}';
			additionalStyle += 'h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {color: ' + newval + ' !important;}';
	...
	wp.customize( 'noo_typo_headings_uppercase', function( value ) {
		value.bind( function( newval ) {
			if( newval ) {
				additionalStyle = 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1, .h2, .h3, .h4, .h5, .h6, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {text-transform: uppercase !important;}';
			} else {
				additionalStyle = 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1, .h2, .h3, .h4, .h5, .h6, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a {text-transform: none !important;}';
			}
	...
	wp.customize( 'noo_typo_body_font', function( value ) {
		value.bind( function( newval ) {
			...
			// Update style
			noo_update_live_css( 'body {font-family: "' + newval + '", sans-serif !important;}' );
		} );
	} );
	...
	wp.customize( 'noo_typo_body_font_style', function( value ) {
		value.bind( function( newval ) {
			...
			// Update style
			noo_update_live_css( 'body {font-style: ' + newval + ' !important;}' );
		} );
	} );
	...
	wp.customize( 'noo_header_logo_image_height', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header .navbar-logo .custom-logo{';
			additionalStyle += 'height: ' + newval + 'px; width: auto; max-width: initial;}';
	...
	wp.customize( 'noo_header_nav_link_spacing', function( value ) {
		value.bind( function( newval ) {
			...
			additionalStyle += 'header .noo-main-menu .navbar-nav > li {margin-left: ' + newval + 'px; margin-right: ' + newval + 'px;}';
