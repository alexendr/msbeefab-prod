...
if ( ! class_exists( 'Noo_Umbra_Check_Version' ) ) {

    class Noo_Umbra_Check_Version {
         ...
         * settings fields so that Noo_Umbra_Check_Version can still find the settings values.
         */
        public function add_license_settings_page() {
            $title = sprintf( esc_html__( '%s License', 'noo-umbra' ), $this->product_name );
        ...
        public function add_license_settings_fields() {
            ...
            add_settings_section(
                $settings_section_id,
                sprintf( noo_umbra_kses( __( 'License <a target="_blank" href="%s" style="">How to get License key?</a>', 'noo-umbra' ) ), 'http://support.nootheme.com/wp-content/uploads/2015/07/HowToGetPurchaseCode.png' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License e-mail or domain address', 'noo-umbra' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License key', 'noo-umbra' ),
        ...
        public function show_admin_notices() {
            ...
            if ( ! $options || ! isset( $options['email'] ) || ! isset( $options['license_key'] ) ||
                ...
                $msg = esc_html__( 'Please enter your license key to enable updates to %s.', 'noo-umbra' );
                ...
                <div class="update-nag">
                    ...
                    <p>
                        <a href="<?php echo admin_url( 'options-general.php?page=' . $this->get_settings_page_slug() ); ?>">
                            <?php echo esc_html__( 'Complete the setup now.', 'noo-umbra' ); ?>
                        </a>
                    </p>
                </div>
            <?php
