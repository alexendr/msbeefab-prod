...
$shop_style = noo_umbra_get_option('noo_woocommerce_product_layout', 'fullwidth');
if( $shop_style == 'boxed' ){
...
if ( $shop_sidebar_layout == 'no_sidebar' && $shop_style == 'fullwidth' ) {
    $shop_style_class .= ' noo-shop-single-fullwidth';
}   
