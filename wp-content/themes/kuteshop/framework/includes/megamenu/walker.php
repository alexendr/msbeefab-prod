<?php
/**
 * Class Name: kuteshop_bootstrap_navwalker
 ...
 */
if ( !class_exists( 'Kuteshop_navwalker' ) ) {
	class Kuteshop_navwalker extends Walker_Nav_Menu
	{
		/**
		...
		public static function fallback( $args )
		{
			if ( current_user_can( 'manage_options' ) ) {
				...
				$fb_output .= '>';
				$fb_output .= '<li class="menu-item"><a href="' . admin_url( 'nav-menus.php' ) . '">' . esc_html__( 'Add a menu', 'kuteshop' ) . '</a></li>';
				$fb_output .= '</ul>';
				if ( $container )
