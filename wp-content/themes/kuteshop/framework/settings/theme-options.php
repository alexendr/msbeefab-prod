			...
			$options[] = array(
				...
				'sections' => array(
					...
					array(
						...
						'title'  => esc_html__( 'Live Search Settings', 'kuteshop' ),
						'fields' => array(
							array(
								...
								'title'      => esc_html__( 'Enable Live Search', 'kuteshop' ),
								'default'    => false,
							),
							array(
								'id'         => 'show_suggestion',
								'type'       => 'switcher',
								'title'      => esc_html__( 'Display suggestion', 'kuteshop' ),
								'dependency' => array(
							...
							array(
								...
								'type'       => 'number',
								'default'    => 3,
								'title'      => esc_html__( 'Search Min Characters', 'kuteshop' ),
								'dependency' => array(
									'enable_live_search', '==', true,
								),
							),
							array(
								...
								'type'       => 'number',
								'default'    => 3,
								'title'      => esc_html__( 'Search Max Characters', 'kuteshop' ),
								'dependency' => array(
									'enable_live_search', '==', true,
								),
							),
							array(
								'id'         => 'search_in',
								'type'       => 'checkbox',
								'title'      => esc_html__( 'Search In', 'kuteshop' ),
								'options'    => array(
									'title'       => esc_html__( 'Title', 'kuteshop' ),
									'description' => esc_html__( 'Description', 'kuteshop' ),
									'content'     => esc_html__( 'Content', 'kuteshop' ),
									'sku'         => esc_html__( 'SKU', 'kuteshop' ),
								),
								'dependency' => array(
									'enable_live_search', '==', true,
								),
